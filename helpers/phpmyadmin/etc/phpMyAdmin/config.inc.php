 ...
 * cookie
 */
$cfg['blowfish_secret'] = 'MV3lGMRAcRyOiW4xbR2GkobBEQMKaGnt'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$i++;
$cfg['Servers'][$i]['host']          = '10.14.24.200'; // MySQL hostname or IP address
